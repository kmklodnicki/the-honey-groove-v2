...
- Recovery progress persisted to `recovery_runs` MongoDB collection

### Profile Layout (BLOCKs 530-542)
- Report/Block icons moved beside profile photo
- Right column cleaned — only Follow/Message, Stripe, Golden Hive
...
- ProfilePage.js decomposition (1200+ lines)
...
- Frontend: /app/frontend/src/pages/CollectionPage.js (TreasuryHeader)
