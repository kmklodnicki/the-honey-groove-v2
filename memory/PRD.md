...
### Completed Recently
- **BLOCK 28: "Reality" Refactor** - DONE (2026-03-09). Collection tabs renamed to "Reality" (owned) + "Dreaming" (wishlist). Reality tagline: "The Main Chamber. Every spin, every memory." Dreaming tagline: "In your dreams..." Desktop/mobile nav renamed from "Collection" → "Reality". Record card dropdown: "Move to Dreaming", "Put on The Hunt", "Remove Completely". Added "Reality vs. Dream Debt" comparison link in value banner.
