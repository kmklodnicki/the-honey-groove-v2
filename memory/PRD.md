...
- **Vinyl Variant & Value Pages** - DONE (2026-03-10). Created dedicated SEO pages at `/vinyl/{artist}/{album}/{variant}` combining variant details, marketplace listings, price/value data, demand trends, and collector activity. Includes SSR for social bots, JSON-LD Product schema, vinyl-specific metadata, and bot detection middleware. Files: `backend/routes/vinyl.py`, `frontend/src/pages/VinylVariantPage.js`, `frontend/src/App.js`, `frontend/craco.config.js`.
