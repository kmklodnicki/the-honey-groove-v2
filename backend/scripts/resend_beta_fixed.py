"""EMERGENCY FIX: Resend beta welcome emails with corrected /forgot-password link."""
...
# All 49 beta signups (same list as original campaign)
RECIPIENTS = [
...
async def main():
    ...
    print(f"\n{'='*60}")
    print(f"  EMERGENCY RESEND: Beta Welcome (fixed CTA)")
