...
const Navbar = () => {
  ...
  return (
    <>
    <nav className="hidden md:block fixed left-0 right-0 z-[100000] glass border-b border-honey/30" style={{ overflow: 'visible', contain: 'none', top: 'var(--oauth-banner-h, 0px)' }}>
    ...
    {/* Mobile Slim Top Bar */}
    {user && (
      <div className="md:hidden fixed left-0 right-0 z-[100000] h-[52px] bg-[#FAF6EE] border-b border-[#C8861A]/10" data-testid="mobile-top-bar" style={{ overflow: 'visible', contain: 'none', top: 'var(--oauth-banner-h, 0px)' }}>
