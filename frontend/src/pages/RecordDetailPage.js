    ...
    <div className="max-w-4xl mx-auto px-4 pt-3 md:pt-2 pb-28" data-testid="record-detail-page">
      ...
      <div className="flex flex-col md:flex-row gap-8 mb-10" data-testid="record-hero">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Spotify attribution — required per Spotify Developer Policy when cover art is Spotify-sourced */}
          {record.imageSource === 'spotify' && (record.spotifyAlbumId || record.spotifyUrl) && (
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs text-[#7A8694] hover:text-[#1DB954] transition-colors mb-6"
              data-testid="detail-spotify-link"
            >
